...
#SBATCH --error=dis_coinfinder-%A-%a.err
#SBATCH --job-name=coinfinder-dis
...
coinfinder -i gene_presence_absence1.csv -I -p tree_1e-06.nwk -o P_coinfinder_dis --dissociate -x 24
